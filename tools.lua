...
minetest.register_tool("admin_tools:pick_admin", {
	...
	inventory_image = "admin_tools_tool_adminpick.png",
	range = 15,
	tool_capabilities = {
...
minetest.register_tool("admin_tools:shovel_admin", {
	description = "Admin Shovel",
	inventory_image = "admin_tools_tool_adminshovel.png",
	wield_image = "admin_tools_tool_adminshovel.png^[transformR90",
	range = 15,
	tool_capabilities = {
		full_punch_interval = 0.0,
		max_drop_level = 3,
...
minetest.register_tool("admin_tools:axe_admin", {
	...
	inventory_image = "admin_tools_tool_adminaxe.png",
	range = 15,
	tool_capabilities = {
		full_punch_interval = 0.0,
		max_drop_level = 3,
...
minetest.register_tool("admin_tools:sword_admin", {
	description = "Admin Sword",
	inventory_image = "admin_tools_tool_adminsword.png",
	range = 15,
	tool_capabilities = {
		full_punch_interval = 0.0,
		max_drop_level = 3,
...
-- Screwdriver
minetest.register_tool("admin_tools:screwdriver", {
	description = "Screwdriver (left-click rotates face, right-click rotates axis)",
	inventory_image = "admin_screwdriver.png",
	range = 15,
	on_use = function(itemstack, user, pointed_thing)
		screwdriver.handler(itemstack, user, pointed_thing, screwdriver.ROTATE_FACE, 0)
		return itemstack
	end,
	on_place = function(itemstack, user, pointed_thing)
		screwdriver.handler(itemstack, user, pointed_thing, screwdriver.ROTATE_AXIS, 0)
		return itemstack
	end,
})
