...
minetest.register_tool("staff_tools:tool", {
	description = "Staff tool",
	inventory_image = "staff_tool.png",
	range = 15,
	tool_capabilities = {
...
-- Screwdriver
minetest.register_tool("staff_tools:screwdriver", {
	description = "Staff Screwdriver (left-click rotates face, right-click rotates axis)",
	inventory_image = "staff_screwdriver.png",
	range = 15,
